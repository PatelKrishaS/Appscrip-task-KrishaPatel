...
//     }}
//   >
//     {/* Render the Image component if selected */}
//     {selectedSort === option && (
//       <Image 
...
//       <button className={styles.mobileFilterBtn}>FILTER</button>
//       <button className={styles.mobileSortBtn}>
//         RECOMMENDED
//         <Image
//           src="/arrow-left.svg"
//           width={14}
...
//       {/* Below top bar — sidebar + grid side by side */}
//       <div className={styles.contentRow}>
//         {showFilter && <FilterSidebar />}

//         <div
//           className={`${styles.grid} ${!showFilter ? styles.gridWide : ""}`}
//         >
